...
static const float GB_CAM_MAX_FILLING_CLAMP = 0.8f;
...
static const float GB_OPACITY_FAR = 0.85f;
...
static const float GB_STRENGTH_CH2 = 1.0;
...
static const float3 BORDER_SUN_INTENSITY = float3(3.0, 3.0, 3.2);
