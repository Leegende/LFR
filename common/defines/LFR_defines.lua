NDefines.NMilitary.BASE_CAPTURE_EQUIPMENT_RATIO = 0.0
...
NDefines.NSupply.SUPPLY_UPDATE_FREQUENCY = 168
...
NDefines.NDeployment.BASE_DEPLOYMENT_TRAINING = 0.36
NDefines.NMilitary.DEPLOY_TRAINING_MAX_LEVEL = 2
NDefines.NMilitary.MIN_DIVISION_DEPLOYMENT_TRAINING = 0.1
NDefines.NAI.DEPLOY_MIN_TRAINING_SURRENDER_FACTOR = 0.0
NDefines.NAI.DEPLOY_MIN_TRAINING_PEACE_FACTOR = 0.0
NDefines.NAI.DEPLOY_MIN_TRAINING_WAR_FACTOR = 0.0
...
NDefines.NNavy.CONVOY_LOSS_HISTORY_TIMEOUT_MONTHS = 0
...
NDefines.NGraphics.WEATHER_DISTANCE_CUTOFF = -1
...
NDefines.NAI.WANTED_UNITS_THREAT_BASE = 0
NDefines.NAI.WANTED_UNITS_THREAT_MAX = 0
NDefines.NAI.WANTED_UNITS_WAR_THREAT_FACTOR = 0
NDefines.NAI.WANTED_UNITS_DANGEROUS_NEIGHBOR_FACTOR = 0
NDefines.NAI.WANTED_UNITS_MANPOWER_DIVISOR = 0
NDefines.NAI.WANTED_UNITS_WEIGHT_FRONTS_WANT = 0
NDefines.NAI.WANTED_UNITS_WEIGHT_FACTORIES = 0
NDefines.NAI.WANTED_UNITS_WEIGHT_MANPOWER = 0
NDefines.NAI.WANTED_UNITS_MIN_DEFENCE_FACTOR =0
